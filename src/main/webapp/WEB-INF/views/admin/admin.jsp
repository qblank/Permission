    ...
    <div class="navbar-container">
        ...
        <div class="navbar-buttons navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle" id="show-user-info">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close" id="user-info">
                        <li>
...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul class="nav nav-list">
            <li class="active">
                <a class="popstyle" href="/sys/dept/list.page" target="_blank">
    ...
    <div class="main-content">
        <iframe id="innerFrame" src="/sys/dept/list.page" width="100%" height="95%" style="min-height: 678px;"></iframe>
    </div>
    <!-- /.main-content -->
...
<script>
    $("#innerFrame").height(window.innerHeight-500);
</script>
<script>
